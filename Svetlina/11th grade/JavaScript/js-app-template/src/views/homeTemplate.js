       ...
       <div class="hero_area">
          ...
          <section class="slider_section ">
             <div class="slider_bg_box">
                <img src="src/images/kitodar.jpg" alt="">
             </div>
             <div id="customCarousel1" class="carousel slide" data-ride="carousel"
                style="background: url(50%-transparent-white.png); background: rgba(255,255,255,0.5); padding: 2rem;">
                         ...
                         <div class="row">
                            <div class="col-md-7 col-lg-6 ">
                               <div class="detail-box">
                                  ...
                                  <p>
                                     We provide the best auto parts, from the best brands. High quality guranteed.
                                  </p>
                                  <div class="btn-box">
                                     <a href="/catalog" class="btn1" style="border-radius: 2rem;">
                                        Shop Now
                                     </a>
                                  </div>
                               </div>
                ...
                <div class="col-md-4">
                   <div class="box ">
                      ...
                      <div class="detail-box">
                         ...
                         <p>
                            If your order is registered before 4PM, you will receive the parts on the same day!
                         </p>
                      </div>
                   </div>
                </div>
                <div class="col-md-4">
                   <div class="box ">
                      ...
                      <div class="detail-box">
                         ...
                         <p>
                            Shipping is free nationwide. Organized shipping every full hour from 9AM to 5PM.
                         </p>
                      </div>
                   </div>
                </div>
                <div class="col-md-4">
                   <div class="box ">
                      ...
                      <div class="detail-box">
                         ...
                         <p>
                            We are working with only with the top brands in the autoparts industry.
                         </p>
                      </div>
                   </div>
                </div>
